  ...
  <div class="googlePwd">
    <div class="main">
      <form class="form-table">
        ...
        <div class="input-box">
          <div class="userName">{{emailUsername}}</div>
        </div>
        <div class="input-box">
          ...
          <div class="hintf" v-show="pwdShow">{{$t('signIn.text6')}}</div>
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
            <smscode
              ...
              height="40px"
            ></smscode>
            <div class="hintfa" :class="{'allHintNullActive': msgAationCodeShow}">{{msgAationCodeHint}}</div>
        </div>
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.$nextTick(() => {
        this.emailUsername = this.$route.query.emailUsername
        this.goemail = this.$route.query.goemail
      })
      // console.log('goemail', this.$route.query.goemail)
    },
    components: {
      smscode
    },
    methods: {
      ...
      verify () {
        ...
        if (this.emailCode === '') {
          ...
          this.msgAationCodeHint = this.$t('signIn.text8')
        }
      },
      gooogleToPwd () {
        this.verify()
        ...
        formData.append('username', this.emailUsername)
        formData.append('password', this.password)
        formData.append('codeType', 2)
        formData.append('code', this.emailCode)
        if (this.emailUsername !== '' && passWordTest.test(this.password) && this.password === this.confirmPassword && this.emailCode !== '') {
      ...
      getEmailCode () {
        ...
        if (this.emailUsername !== '') {
          this.$http.post(`${this.$api}/user/sendEmailCode?email=${this.goemail}&sendType=1`).then((res) => {
    ...
    .main{
      ...
      .form-table{
        ...
        .input-box{
          ...
          /deep/ .sms-container .sms-btn span{
